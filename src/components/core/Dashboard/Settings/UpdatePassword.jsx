    ...
    <div>
      <form onSubmit={handleSubmit(submitPasswordForm)}>
        <div className='my-5 rounded-md border border-richblack-700 bg-richblack-800 p-8 px-12'>
          ...
          <div className='flex flex-col lg:flex-row gap-5' >
            <div className='relative flex flex-col gap-x-2 w-full' >
              <label htmlFor="oldPassword" className='label-style tracking-wider mb-1' >Your Password <span className='text-pink-100'>*</span></label>
              <input
                name='oldPassword'
                id='oldPassword'
          ...
          className="w-full rounded-[0.5rem] bg-richblack-800 p-[12px] text-richblack-5"
            ...
            <div className='relative flex flex-col gap-x-2 w-full' >
              <label htmlFor="newPassword" className='label-style  tracking-wider mb-1' >New Password <span className='text-pink-100'>*</span></label>
              <input
                name='newPassword'
                id='newPassword'
                placeholder='Enter Current Password'
        ...
        <div className='flex justify-end gap-2'>
          <button onClick={() => navigate('/dashboard/myprofile')} className={`rounded-md bg-richblack-700 lg:py-2 py-1 lg:px-5 px-2 font-semibold text-richblack-50 uppercase tracking-wider 
